...
contract MockSynassetsStaking is Ownable {
    ...
    /**
        @notice stake SYNASSETS to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sSYNASSETS from warmup
        @param _recipient address
     */
    function claimToken ( address _recipient, address _inviter ) public {
        Claim memory info = warmupInfo[ _recipient ];
    ...
    /**
        @notice forfeit sSYNASSETS in warmup and retrieve SYNASSETS
     */
    ...
    /**
        @notice redeem sSYNASSETS for SYNASSETS
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns the sSYNASSETS index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract SYNASSETS holdings, including bonuses provided
        @return uint
     */
