...
async function main() {
    ...
    await proxyTOKEN_SALE_OG.connect(logicOwner).__TokenSale_initialize(
        ...
        ["5","571428500000000000000000000000000000000","15","100000000000000",openAt,closeAt,"1000000000000","1000000000","1000000000","40000000000000000","10000000000000000"]
    );
    ...
    await proxyTOKEN_SALE_PC.connect(logicOwner).__TokenSale_initialize(
        ...
        ["15","363636300000000000000000000000000000000","20","100000000000000",openAt,closeAt,"1000000000000","10000000000","500000000","40000000000000000","10000000000000000"]
    );
